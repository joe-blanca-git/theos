...
@Component({
  selector: 'app-landing-professores',
  templateUrl: './landing-professores.component.html',
  styleUrls: ['./landing-professores.component.scss',
              '../landing-page/landing-page.component.css', 
              '../landing-page/landing-page.bootstrap.css',]
})
export class LandingProfessoresComponent implements OnInit{
  ...
  public professores: any = [
    {
      ...
      LinkInstagram: '',
      LinkLinkedin: '',
      LinkImagem: '../../../../assets/img/professores/cleber2.png'
    },
    {
      UserId: 2,
      ...
      LinkInstagram: '',
      LinkLinkedin: '',
      LinkImagem: '../../../../assets/img/professores/jefferson2.png'
    },
    {
      UserId: 3,
      ...
      LinkInstagram: '',
      LinkLinkedin: '',
      LinkImagem: '../../../../assets/img/professores/tiago2.png'
    },
    {
      UserId: 4,
      Nome: 'Fernando Prado',
      ...
      LinkInstagram: '',
      LinkLinkedin: '',
      LinkImagem: '../../../../assets/img/professores/fernando2.png'
    },
    {
      UserId: 5,
      Nome: 'Joeder Blanca',
      ...
      LinkInstagram: '',
      LinkLinkedin: '',
      LinkImagem: '../../../../assets/img/professores/joe2.png'
    }
  ];
